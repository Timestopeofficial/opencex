# how to rebuild and apply peatio
* cd /root/mojaikdax_peatio/

* chmod 755 ./bin/init_config
* chmod 755 ./bin/link_config

* https://hub.docker.com/

* docker build --tag <your-docker-store/your-image-name:your-image-version> .
* docker login
* docker push <your-docker-store/your-image-name:your-image-version>

* cd /root/opendax/
* vi ./config/app.yml
* peatio: <your-docker-store/your-image-name:your-image-version>
* rake render:config && rake service:app

# how to add dogecoin
* https://github.com/Satoex/peatio-dogecoin

* create folder mojaikdax_peatio\lib\peatio\dogecoin
* add blockchain.rb, client.rb, wallet.rb in dogecoin folder

* add code mojaikdax_peatio\config\initializers\blockchain_api.rb
* Peatio::Blockchain.registry[:dogecoin] = Dogecoin::Blockchain

* add code mojaikdax_peatio\config\initializers\wallet_api.rb
